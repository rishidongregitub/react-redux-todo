...
import { markIncompleted, removeTodo, toggleTodo } from '../redux/todoSlice';
  ...
  return (
    <li className="flex flex-col sm:flex-row sm:items-center justify-between border-b-2 py-2 gap-4">
      ...
      <div className="space-x-3 ml-3">
        ...
        {
          todo.completed && (
            <button onClick={() => dispatch(markIncompleted(index))} className='mr-2 text-sm bg-yellow-500 text-white sm:px-2 py-1 px-1 rounded'><FaTimes /></button>
          )
        }
      </div>
    </li>
